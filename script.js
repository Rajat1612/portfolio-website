...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.timeline-item, .education-card, .project-card, .certification-card, .skill-item');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    sections.forEach(section => {
        ...
        animateOnScroll(section, 'visible');
    });
